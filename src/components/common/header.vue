    ...
    <div class="header" :class="{act:scrollTag}">
        ...
        <ul>
            <li @mouseover="over" @mouseleave="leave">  
               产品                          
                <div class="product_box" v-show="showProduct" @mouseleave="leave">
                    <div class="min">
                        <ul>
                            <li @mouseover="changeActive(1)" :class="{'active':activeTab==1}">
                                <span>建筑管理平台</span>
                                <div class="info_box" v-show="activeTab==1">
                                    <h3>建筑管理平台<span class="dayu">&nbsp;></span></h3>
                                    <div class="div1">
                                        <p class="p1">建筑信息模型</p>
                                        <p>建筑体模型管理</p>
                                        <p>设备模型管理</p>
                            ...
                            <li @mouseover="changeActive(2)" :class="{'active':activeTab==2}">
                                <span>资产管理平台</span>
                                <div class="info_box" v-show="activeTab==2">
                                    <h3  @click="$router.push('/asset-platform?showflag')">资产管理平台<span class="dayu">&nbsp;></span></h3>
                                    <div class="div1">
                                        <p class="p1">资产概览</p>
                                        <p>资产统计</p>
                                        <p>资产分析</p>
                            ...
                            <li @mouseover="changeActive(3)" :class="{'active':activeTab==3}">
                                <span>物业管理平台</span>
                                <div class="info_box" v-show="activeTab==3">
                                    <h3>物业管理平台<span class="dayu">&nbsp;></span></h3>
                                    <div class="div1">
                                        <p class="p1">设备管理</p>
                                        <p>设备添加</p>
                                        <p>设备组态</p>
                            ...
                            <li @mouseover="changeActive(4)" :class="{'active':activeTab==4}">
                                <span>能源管理平台</span>
                                <div class="info_box" v-show="activeTab==4">
                                    <h3  @click="$router.push('/energy-platform?showflag')">能源管理平台<span class="dayu">&nbsp;></span></h3>
                                    <div class="div1">
                                        <p class="p1">能耗统计</p>
                                        <p>能耗计量</p>
                                        <p>能耗分类</p>
                            ...
                            <li @mouseover="changeActive(6)" :class="{'active':activeTab==6}">
                                <span>出行管理平台</span>
                                <div class="info_box" v-show="activeTab==6">
                                    <h3 @click="$router.push('/trip-platform?showflag')">出行管理平台<span class="dayu">&nbsp;></span></h3>
                                    <div class="div1">
                                        <p class="p1">业主出行</p>
                                        <p>业主车场出行</p>
                                        <p>门禁出行</p>
                            ...
                            <li @mouseover="changeActive(7)" :class="{'active':activeTab==7}">
                                <span>安防管理平台</span>
                                <div class="info_box" v-show="activeTab==7">
                                    <h3 @click="$router.push('/security-platform?showflag')">安防管理平台<span class="dayu">&nbsp;></span></h3>
                                    <div class="div1">
                                        <p class="p1">报警管理</p>
                                        <p>报警机制管理</p>
                                        <p>报警流程管理</p>
                            ...
                            <li @mouseover="changeActive(8)" :class="{'active':activeTab==8}">
                                <span>企业服务平台</span>
                                <div class="info_box" v-show="activeTab==8">
                                    <h3  @click="$router.push('/enterprise-platform?showflag')">企业服务平台<span>&nbsp;></span></h3>
                                    <div class="div1">
                                        <p class="p1">区域经济分析</p>
                                        <p>区域消费类型统计</p>
                                        <p>区域业态统计</p>
                            ...
                            <li @mouseover="changeActive(9)" :class="{'active':activeTab==9}">
                                <span>商圈管理平台</span>
                                <div class="info_box" v-show="activeTab==9">
                                    <h3>商圈管理平台<span class="dayu">&nbsp;></span></h3>
                                    <div class="div1">
                                        <p class="p1">商圈经济分析</p>
                                        <p>商圈数据录入</p>
                                        <p>商圈数据爬取</p>
                            ...
                            <li @mouseover="changeActive(10)" :class="{'active':activeTab==10}">
                                <span>应急管理平台</span>
                                <div class="info_box" v-show="activeTab==10">
                                    <h3>应急管理平台<span class="dayu">&nbsp;></span></h3>
                                    <div class="div1">
                                        <p class="p1">事件管理</p>
                                        <p>事件发起条件</p>
                                        <p>事件推送机制</p>
                            ...
                            <li @mouseover="changeActive(11)" :class="{'active':activeTab==11}">
                                <span>数据管理平台</span>
                                <div class="info_box" v-show="activeTab==11">
                                    <h3>数据管理平台<span class="dayu">&nbsp;></span></h3>
                                    <div class="div1">
                                        <p class="p1">设备数据</p>
                                        <p>设备模型</p>
                                        <p>设备接入</p>
                            ...
                            <li @mouseover="changeActive(12)" :class="{'active':activeTab==12}">
                                <span>场景应用中心</span>
                                <div class="info_box" v-show="activeTab==12">
                                    <h3>场景应用中心<span class="dayu">&nbsp;></span></h3>
                                    <div class="div1">
                                        <p class="p1">智慧家居</p>
                                        <p>联动管理</p>
                                        <p>情景定义</p>
