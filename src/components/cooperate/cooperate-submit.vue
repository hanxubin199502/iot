    ...
    <div class="content center">
      ...
      >
        ...
        <el-form-item label="合作说明：" prop="cooperateRemark">
          <el-input
            v-model="cooperateForm.cooperateRemark"
            type="textarea"
            :rows="5"
      ...
      <div v-else class="finish center">
        ...
        <div class="finish_countdown">
          将在&nbsp;
          <span>{{countDown<0?'0':countDown}}</span>&nbsp;秒后跳转至
          <span @click="toHomePage" class="finish_countdown_path">&nbsp;&nbsp;首页&nbsp;&nbsp;</span>
        </div>
      </div>
    </div>
    <footerBar/>
    ...
    sendForm() {
      this.$refs["cooperateForm"].validate(valid => {
        if (valid) {
          ...
          for (
            var i = 0;
            i < this.cooperateForm.cooperateTypeList.length;
            i++
          ) {
            // 简单深拷贝
      ...
      .cooperate_area {
        ...
        .cooperate_item {
          ...
          .cooperate_item_logo1 {
            background: url(../../assets/images/cooperate-item-logo1.png) center
              center;
          }
          .cooperate_item_logo2 {
            background: url(../../assets/images/cooperate-item-logo2.png) center
              center;
          }
          .cooperate_item_logo3 {
            background: url(../../assets/images/cooperate-item-logo3.png) center
              center;
          }
          .cooperate_item_logo4 {
            background: url(../../assets/images/cooperate-item-logo4.png) center
              center;
          }
          .cooperate_item_name {
            position: absolute;
